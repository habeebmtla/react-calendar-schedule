...
var DayEvents = function DayEvents(props) {
  ...
  }), dayEvents && dayEvents.length > 5 && /*#__PURE__*/React__default.createElement("div", {
    className: monthStyles.event
  }, dayEvents.length - 5, "+"));
};
...
var WeekRow = function WeekRow(props) {
  ...
  return /*#__PURE__*/React__default.createElement("tr", null, days && days.map(function (item, index) {
    ...
    }, item.format('DD')), /*#__PURE__*/React__default.createElement(DayEvents, {
      dayEvents: dayEvents,
...
var WeekHeader = function WeekHeader(props) {
  ...
  return /*#__PURE__*/React__default.createElement("thead", null, /*#__PURE__*/React__default.createElement("tr", null, weeks && weeks.map(function (item, index) {
...
var Month = function Month(props) {
  ...
  }, /*#__PURE__*/React__default.createElement("table", null, /*#__PURE__*/React__default.createElement(WeekHeader, {
    fixedHeader: fixedHeader
  }), /*#__PURE__*/React__default.createElement("tbody", null, range && range.map(function (item, index) {
    return /*#__PURE__*/React__default.createElement(WeekRow, _extends({
...
var Events = function Events(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, events && events.map(function (item, index) {
    var _getEventSpecs = getEventSpecs(item),
        height = _getEventSpecs.height,
        offset = _getEventSpecs.offset;

    if (resource && resource[resourceIdAccessor] === item[resourceIdAccessor] || !resource) return /*#__PURE__*/React__default.createElement("div", {
      key: index,
    ...
    }, moment(item.start).format('hh:mm A'), " - ", moment(item.end).format('hh:mm A')), /*#__PURE__*/React__default.createElement("br", null), item.title);
  }));
};
...
var DayRow = function DayRow(props) {
  ...
  return /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("td", {
    ...
    return /*#__PURE__*/React__default.createElement("td", {
      ...
      key: index
    }, /*#__PURE__*/React__default.createElement(Events, _extends({
      resource: item
    }, {
      dayEvents: dayEvents,
  ...
  }, /*#__PURE__*/React__default.createElement(Events, {
    dayEvents: dayEvents,
    selectedDate: selectedDate,
    time: time,
    resourceIdAccessor: resourceIdAccessor,
...
var Resources = function Resources(props) {
  var resources = props.resources,
      ...
      fixedHeader = props.fixedHeader;
  return /*#__PURE__*/React__default.createElement("thead", null, /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("th", {
    style: {
      background: '#fff'
    }
...
var Day = function Day(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    fixedHeader: fixedHeader
  }), /*#__PURE__*/React__default.createElement("tbody", null, timeArray && timeArray.map(function (item, index) {
    return /*#__PURE__*/React__default.createElement(DayRow, _extends({
      key: index,
      time: item
    }, {
      resources: resources,
...
var ToolBar = function ToolBar(props) {
  ...
  }, "day"), /*#__PURE__*/React__default.createElement("button", {
    onClick: function onClick() {
      return onViewChange('week');
    }
  }, "week"), /*#__PURE__*/React__default.createElement("button", {
    onClick: function onClick() {
...
var WeekEvents = function WeekEvents(props) {
  ...
  }), weekEvents[dateTime] && weekEvents[dateTime].length > 5 && /*#__PURE__*/React__default.createElement("div", {
    className: styles.event
...
var TimeRow = function TimeRow(props) {
  ...
  return /*#__PURE__*/React__default.createElement("tbody", null, /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("td", {
    ...
    return /*#__PURE__*/React__default.createElement("td", {
      ...
      key: index
    }, /*#__PURE__*/React__default.createElement(WeekEvents, _extends({
...
var Week = function Week(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    return /*#__PURE__*/React__default.createElement(TimeRow, _extends({
      key: index,
      time: item
    }, {
      weekArray: weekArray,
...
var ReactCalendarSchedule = function ReactCalendarSchedule(props) {
  ...
  var _useState = React.useState(props.view),
      view = _useState[0],
      onViewChange = _useState[1];

  var _useState2 = React.useState(props.date),
      date = _useState2[0],
  ...
  var getView = function getView() {
    switch (view) {
      case 'month':
        return /*#__PURE__*/React__default.createElement(Month, _extends({}, props, {
          date: date
        }));

      case 'day':
        return /*#__PURE__*/React__default.createElement(Day, _extends({}, props, {
          date: date
        }));

      case 'week':
        return /*#__PURE__*/React__default.createElement(Week, _extends({}, props, {
          date: date
        }));
...
module.exports = ReactCalendarSchedule;
